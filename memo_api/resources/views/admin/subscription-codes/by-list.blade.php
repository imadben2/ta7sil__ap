...
@section('title', 'الأكواد حسب القائمة')
@section('page-title', 'عرض الأكواد مجمعة حسب اسم القائمة')
    ...
    <div class="bg-gradient-to-r from-purple-600 to-indigo-600 rounded-xl shadow-lg p-6">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div class="text-white">
                <h2 class="text-2xl font-bold mb-2">الأكواد حسب القائمة</h2>
                <p class="text-purple-100">عرض جميع الأكواد مجمعة حسب اسم القائمة</p>
            </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-purple-600">{{ $stats['total_lists'] }}</p>
                </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4" id="filters-form">
            ...
            <div>
                ...
                <select id="filter-code-type" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500">
            ...
            <div>
                ...
                <select id="filter-course" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500">
            ...
            <div>
                ...
                <select id="filter-package" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500">
...
$(document).ready(function() {
    var table = $('#codes-table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "{{ route('admin.subscription-codes.by-list') }}",
            data: function(d) {
        ...
        columns: [
            { data: 'list_name', name: 'name', orderable: true },
