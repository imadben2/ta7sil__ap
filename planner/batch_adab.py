#!/usr/bin/env python3
"""
Script to batch images from adab folder into adab_batch folders
...
# Configuration
ADAB_DIR = Path(__file__).parent / "مستر باك - آداب وفلسفة (1)"
...
def main():
    # Get all jpg files
    jpg_files = list(ADAB_DIR.glob("*.jpg"))
    print(f"Found {len(jpg_files)} images in adab folder")
    ...
    for i, batch in enumerate(batches, 1):
        ...
        # Create batch folder with adab_batch name
